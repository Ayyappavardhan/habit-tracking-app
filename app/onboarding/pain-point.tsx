/**
 * Onboarding - Pain Point Screen
 * Addresses the feeling of overwhelm/busyness.
 */
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: ONBOARDING_COLORS.background }]}>
            ...
            <View style={styles.content}>
                <View style={styles.imageWrapper}>
                    <Image
                        source={require('@/assets/images/onboarding/onboarding-pain-point.png')}
                        style={styles.image}
                        resizeMode="contain"
                    />
                ...
                <Text style={[styles.subtitle, { color: ONBOARDING_COLORS.textSecondary }]}>
                    Motivation fades and life gets busy. It's easy to lose track of your goals when you try to do too much.
                </Text>
            </View>
            ...
            <View style={styles.footer}>
                <TouchableOpacity
                    ...
                    onPress={() => router.push('/onboarding/solution-method')}
                >
